    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">Desaged</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                        DesaGED is an interactive tourism application that leverages Augmented Reality (AR) and Virtual Reality (VR) technologies to enhance the visitor experience in rural tourism villages. The app allows users to explore cultural heritage, local attractions, and historical landmarks through immersive digital content, aiming to boost engagement, education, and tourism potential in underserved areas.
                        Designed with accessibility and storytelling in mind, DesaGED serves as a smart tourism solution to help villages preserve their identity while embracing modern technology.
                    </p>    
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center">
                    <img src="/photos/desaged/prev1.png" className="md:w-4/6" alt="desaged" />
                </div>
                ...
                <div className="flex justify-center items-center gap-8 flex-col">
                    <img src="/photos/desaged/1.webp" className="shadow-2xl w-4/6" alt="desaged" />
                </div>
            </motion.div>
