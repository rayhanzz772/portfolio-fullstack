    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">WeCare</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                    ...
                    <p className="text-l font-semibold md:text-xl">UI/UX</p>
                    </div>
                    <div className="flex items-center">
                    <span className="bg-black  px-4 py-1 rounded-full text-white text-l md:text-xl mr-4 md:mr-6">Tech</span>
                    <p className="text-l font-semibold md:text-xl">Figma</p>
                    </div>
                </div>
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                   WeCare is a mental health-focused UI/UX design project developed using Figma, aimed at promoting awareness, self-care, and accessible support for the general public. The platform is designed to educate users about mental health while providing practical tools to monitor and manage their emotional well-being.
                    A standout feature of WeCare is its integration with biometric sensors to track mental health through heart rate activity. By collecting real-time physiological data, the system helps users gain deeper insights into their mental state, offering more personalized support and recommendations.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center flex-col gap-6 rounded-2xl">
                    <img src="/photos/wecare/prev1.png" className="md:w-4/6" alt="img" />
                    <img src="/photos/wecare/prev2.png" className="md:w-4/6" alt="img" />
                </div>
