    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">Mental Care App</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                    MentalCare is a mental health application designed to help users assess their psychological well-being through the clinically validated PHQ-9 (Patient Health Questionnaire-9) screening method. The app guides users through a series of self-assessment questions to evaluate symptoms of depression and provides scoring insights based on their responses.
                    In addition to the screening feature, MentalCare also offers guided meditation sessions aimed at helping users manage stress, anxiety, and improve overall emotional balance. The app promotes mental wellness by combining clinical assessment tools with practical self-care techniques.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center">
                    <img src="/photos/mentalcare/prev1.png" className="md:w-4/6" alt="floodsenseai" />
                </div>
