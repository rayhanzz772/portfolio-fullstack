    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">Mevent</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                    Mevent is a comprehensive project management application designed to streamline collaboration, task tracking, and budgeting within teams. The app features a structured system that organizes projects by division, main tasks, subtasks, and individual responsibilities, providing clarity and control across all levels of execution.
                    In addition to task management, Mevent includes division-level budgeting tools to monitor and manage financial allocations, as well as an integrated chat feature to enhance team communication in real-time.
                    The user interface was carefully crafted to balance functionality and usability, which led to Mevent being awarded 2nd place in a UI/UX design competition for its innovative structure and intuitive user experience.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center">
                    <img src="/photos/mevent/prev1.png" className="md:w-4/6" alt="mevent" />
                </div>
                ...
                <div className="flex justify-center items-center gap-8 flex-col">
                    <img src="/photos/mevent/1.webp" className="shadow-2xl w-4/6" alt="mevent" />
                </div>
            </motion.div>
