    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">Applied Machine Learning</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                    {[
                        ...
                        { label: "Type", value: "Applied Machine Learning" },
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                    This certification demonstrates my ability to implement practical machine learning solutions using Python. Through the course, I gained hands-on experience in preparing datasets, building and evaluating supervised and unsupervised models, and applying key algorithms such as linear regression, decision trees, and clustering.
                    I also learned to use industry-standard tools such as Scikit-learn, TensorFlow, and Pandas to solve real-world problems efficiently. The program emphasized end-to-end workflows, including data preprocessing, model training, evaluation, and deployment.
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/appMLcert/prev1.webp" className="md:w-5/6" alt="appMLcert" />
                </div>

                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/appMLcert/prev2.webp" className="md:w-5/6" alt="appMLcert" />
                </div>

                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/appMLcert/prev3.webp" className="md:w-5/6" alt="appMLcert" />
                </div>
            </motion.div>
