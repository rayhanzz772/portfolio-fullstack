    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">Machine Learning for Android</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                        This certification showcases my ability to integrate machine learning models into Android applications. The course focused on applying ML concepts such as image classification and object detection using TensorFlow Lite, enabling on-device inference for fast and efficient performance.
                        Throughout the program, I learned how to convert and optimize machine learning models, implement them in Kotlin-based Android apps, and create user-friendly interfaces for real-time predictions.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/MLAndroid/prev1.webp" className="md:w-5/6" alt="MLAndroid" />
                </div>

                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/MLAndroid/prev2.webp" className="md:w-5/6" alt="MLAndroid" />
                </div>

                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/MLAndroid/prev3.webp" className="md:w-5/6" alt="MLAndroid" />
                </div>
            </motion.div>
