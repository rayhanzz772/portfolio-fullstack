    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">SoilAI (Paper)</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                    ...
                    <p className="text-l font-semibold md:text-xl">Paper</p>
                    </div>
                </div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center">
                    <img src="/photos/soilai/prev1.png" className="md:w-4/6" alt="soilai" />
                </div>
            </motion.div>
