    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">1st Winner Essay Competition</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                    ...
                    <p className="text-l font-semibold md:text-xl">UPN Veteran Jakarta</p>
                    </div>
                </div>
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                    Awarded 1st place in a national-level essay competition held by Universitas Pembangunan Nasional Veteran Jakarta (UPNVJ), under the theme of technology for development. My essay focused on the innovative use of Augmented Reality (AR) and Virtual Reality (VR) to accelerate digital transformation in rural areas.
                    The proposal emphasized how AR/VR can enhance education, training, and tourism in villages, making advanced technology more accessible and empowering communities to grow sustainably in the digital era.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/EssayUPNVJ/prev1.jpeg" className="md:w-5/6" alt="EssayUPNVJ" />
                </div>
            </motion.div>
