    ...
    >
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left">
                <h1 className="text-4xl font-semibold">2nd UI/UX Competition</h1>
            </motion.div>
            ...
            >
                ...
                <div className="md:col-span-4 text-sm md:text-xl font-normal md:font-thin">
                    <p>
                    Achieved 2nd place in a UI/UX design competition held by Politeknik Negeri Semarang (Polines), focusing on the theme of building a project management application for Android. The design emphasized intuitive task tracking, team collaboration features, and user-friendly navigation tailored for mobile users.
                    My submission stood out for its clean layout, consistent design system, and thoughtful user flow, aiming to improve productivity and project organization for students and professionals.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="w-11/12 md:w-9/12 text-left space-y-10">
                ...
                <div className="flex justify-center items-center flex-cols">
                    <img src="/photos/EssayPolines/prev1.webp" className="md:w-4/6" alt="EssayPolines" />
                </div>
            </motion.div>
